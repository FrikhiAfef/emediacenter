                                ...
                                <div class="qt-header-bottom">
                                    <div class="qt-item-metas">
                                        <a class="qt-author-thumb" href="#author-url">
                                            <img src=/public/images/{{($emission->image) }} alt="" width="30" height="30">
                                        </a>
                                        <div class="qt-texts">
                                            <p class="qt-author"><a href="">
                                                    Animateur :  {{$emission->nomAnim}} </a></p>
                                            <p class="qt-date"> {{$emission->date}}</p>
                                        </div>
                                    </div>
                                    <a href="#" class="qt-btn qt-btn-primary qt-readmore"><i class="dripicons-align-justify"></i></a>
                                </div>
                                <div class="qt-header-bg" data-bgimage='/public/images/{{($emission->image) }}'>
                                    <img src='/public/images/{{($emission->image) }} alt="Featured image'width="690" height="302">
                                </div>
                            </div>
                            <div class="qt-item-content qt-card qt-the-content">
                                {!! html_entity_decode($emission->description) !!}
                            </div>
                        </div>
                @endforeach
