                ...
                <div class="col s12 m3 l3">
                    <div class="qt-widget">
                        ...
                        <ul class="qt-widget-menu qt-list-chevron">
                            ...
                            <li>
                                <a href="{{route('emission')}}">Emissions</a>
                            </li>
                            <li>
                                <a href="{{route('evenement')}}">Evénements</a>
                            </li>
                            <li>
            ...
            <div class="row">
                <div class="col s12 m12 l8">
                    ...
                    <ul class="qt-menu-footer qt-small qt-list-chevron ">
                        ...
                        <li><a href="{{route('inscriptionhome')}}"><i class="dripicons-chevron-right"></i>Inscription</a></li>
                ...
                <div class="col s12 m12 l4">
                    <ul class="qt-menu-social">
                        ...
                        <li class="right"><a href="https://www.facebook.com/Elgazala-Technopark-391558404369877/"><i class="qticon-facebook"></i></a></li>
                        <li class="right"><a href="http://twitter.com/home?status=Votre%20Tweet%20ici:%20http://VotreURL.com "><i class="qticon-twitter"></i></a></li>
