        ...
        <div class="qt-part-event-featured qt-card qt-negative qt-vertical-padding-l">
            <div class="qt-event-featured-content">
                ...
                <div class="qt-countdown-container">
                    <div id="countdown" class="ClassyCountdownDemo qt-countdown" data-end="2018-05-15"></div>
                </div>
                <p>
                    <a href="#" target="_blank" class="qt-btn qt-btn-primary qt-btn-l">Voir Plus</a>
                </p>
            </div>
                            ...
                            <li class="qt-part-chart qt-chart-track qt-negative qt-card-s">
                                <div class="qt-chart-table collapsible-header qt-content-primary">
                                    <div class="qt-position">
                                        <img src="/public/images/{{($evenement->image) }}" class="qt-chart-cover" alt="Chart track" width="170" height="170">
                                    </div>
                                    <div class="qt-titles">
                                ...
                                <div class="collapsible-body qt-paper">
                                    <img src="/public/images/{{($evenement->image) }}" >
                                </div>
                            </li>
                    @endforeach
                    <!-- CHART TRACK END ========================= -->
                    ...
                    <div class="col s12 m4">
                        <div class="qt-part-archive-item qt-item-chart">
                            <div class="qt-item-header">
                                ...
                                <div class="qt-header-bg" data-bgimage="/public/images/{{($evenement->image) }}">
                                    <img src="/public/images/{{($evenement->image) }}" alt="Featured image" width="690" height="690">
                                </div>
                            </div>
                        </div>
                    </div>
