                                ...
                                <div class="qt-header-bottom">
                                    <div class="qt-item-metas">
                                        <a class="qt-author-thumb" href="">
                                            <img src=/public/images/{{($apropo->image) }} alt="" width="30" height="30">
                                        </a>
                                    </div>
                                    <a href="#" class="qt-btn qt-btn-primary qt-readmore"><i class="dripicons-align-justify"></i></a>
                                </div>
                                <div class="qt-header-bg" data-bgimage='/public/images/{{($apropo->image) }}'>
                                    <img src='/public/images/{{($apropo->image) }} alt="Featured image'width="80" height="90">
                                </div>
                            </div>
                            <div class="qt-item-content qt-card qt-the-content">
                                {!! html_entity_decode($apropo->description) !!}								</div>
                        </div>
